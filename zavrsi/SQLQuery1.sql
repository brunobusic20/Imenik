...
create table email(
	sifra int not null primary key identity(1,1),
	emailadresa varchar(100)
)


alter table email add foreign key (sifra) references kontakt(sifra);

insert into kontakt(ime,prezime,broj,adresa)
values('Bruno','Buši?','0998474271','Petefija Sandora 16');

insert into email(emailadresa)
values('brunobusic20@gmail.com');
...
insert into email(emailadresa)
values
('angelabusic29@gmail.com'),
('gabrielabusic9@gmail.com');
