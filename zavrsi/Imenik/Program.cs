...
builder.Services.AddSwaggerGen(sgo => { // sgo je instanca klase SwaggerGenOptions
    ...
    var o = new Microsoft.OpenApi.Models.OpenApiInfo()
    {
        ...
        {
            Email = "brunobusic20@gmail.com",
            Name = "Bruno Bušić"
        },
        Description = "Ovo je dokumentacija za Imenik API",
...
builder.Services.AddDbContext<ImenikContext>(o =>
    o.UseSqlServer(
        builder.Configuration.
        GetConnectionString(name: "ImenikContext")
        )
    );
